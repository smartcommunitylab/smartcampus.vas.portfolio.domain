...
public class  StudentDataServiceInterface extends DomainTypeInterfaceImpl {

    private static DomainTypeInterface intf = null;
    public static DomainTypeInterface getInstance() {
        if (intf==null) intf = new StudentDataServiceInterface();
        return intf;
    }
    ...
    static {
        ...
        ArgumentDefImpl a = null;
        p = new PortImpl();
        p.setName("updateStudentData");
        a = new ArgumentDefImpl();
        a.setName("data");
        a.setType(new Type(smartcampus.services.esse3.data.StudentData .class, false));
        p.addArgument(a);
        a = new ArgumentDefImpl();
