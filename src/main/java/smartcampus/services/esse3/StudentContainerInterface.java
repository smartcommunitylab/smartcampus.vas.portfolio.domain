...
public class  StudentContainerInterface extends DomainTypeInterfaceImpl {

    private static DomainTypeInterface intf = null;
    public static DomainTypeInterface getInstance() {
        if (intf==null) intf = new StudentContainerInterface();
        return intf;
    }
    ...
    static {
        ...
        rd.setName("presentation");
        rd.setType(new Type(smartcampus.services.esse3.UserProducedDataInterface .getInstance(), false));
        relDefs.add(rd);
        rd = new RelDefImpl();
        rd.setVisibility(Visibility.PUBLIC);
        rd.setName("skills");
        rd.setType(new Type(smartcampus.services.esse3.UserProducedDataInterface .getInstance(), true));
        relDefs.add(rd);
    }    
    ...
    static {
        ...
        o = new OperationImpl();
        o.setName("updatePresentation");
        o.setVisibility(Visibility.PUBLIC);
        a = new ArgumentDefImpl();
        a.setName("newPresentation");
        a.setType(new Type(smartcampus.services.esse3.UserProducedDataInterface .getInstance(), false));
        o.addArgument(a);
        operations.add(o);

        o = new OperationImpl();
        o.setName("updateSkills");
        o.setVisibility(Visibility.PUBLIC);
        a = new ArgumentDefImpl();
        a.setName("newSkills");
        a.setType(new Type(smartcampus.services.esse3.UserProducedDataInterface .getInstance(), true));
        o.addArgument(a);
        operations.add(o);
    }    
    @Override
