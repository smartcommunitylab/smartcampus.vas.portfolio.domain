...
public class  PortfolioFactoryInterface extends DomainTypeInterfaceImpl {

    private static DomainTypeInterface intf = null;
    public static DomainTypeInterface getInstance() {
        if (intf==null) intf = new PortfolioFactoryInterface();
        return intf;
    }
    ...
    static {
        ...
        o.addArgument(a);
        a = new ArgumentDefImpl();
        a.setName("newUserSocialId");
        a.setType(new Type(java.lang.Long .class, false));
        o.addArgument(a);
        a = new ArgumentDefImpl();
        a.setName("newName");
        a.setType(new Type(java.lang.String .class, false));
